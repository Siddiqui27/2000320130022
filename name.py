...
Make sure to install the required dependencies (Flask and requests) by running:

Copy code
pip install Flask requests
Save the code in a Python file, for example, number_management_service.py, and then run it:

Copy code
python number_management_service.py
